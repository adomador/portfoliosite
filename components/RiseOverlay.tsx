...
import styles from './RiseOverlay.module.css'

const RISE_DURATION_MS = 2500
const DISSOLVE_START_BEFORE_END_MS = 500

interface RiseOverlayProps {
  leafRect: DOMRect
  onTransitionEnd: () => void
}

export default function RiseOverlay({
  leafRect,
  onTransitionEnd,
}: RiseOverlayProps) {
  ...
  useEffect(() => {
    ...
    }, RISE_DURATION_MS - DISSOLVE_START_BEFORE_END_MS)
